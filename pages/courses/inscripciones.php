...
<head>
  ...
  <link href="../../assets/css/styleInscripciones.css" rel="stylesheet">
  <!-- Favicon -->
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <main class="body-content">
    ...
    <div class="ms-content-wrapper">
      <div class="panel-insc">
        <div class="panel-header">
          <div class="icon"><i class="material-icons">people</i></div>
          <div>
            <div style="font-weight:800;line-height:1;">Gestión de Inscripciones</div>
            <div class="text-muted-2" style="font-size:.85rem;">Asignar alumnos a la clase seleccionada:</div>
          </div>
        </div>
        ...
        <div class="panel-body">
          <form id="formInscripciones">
            ...
            <div class="form-group mb-3">
              <label for="selectClase" style="font-weight:600;">Clase</label>
            ...
            <div class="row">
              ...
              <div class="col-md-5">
                <div class="card-box">
                  <h6>
                    Inscritos a <span id="tituloClase"></span>
                    <span class="badge-soft" id="countInscritos">0</span>
                  </h6>
                  <div class="table-slim">
                    <table class="table table-sm table-hover mb-0" id="tablaInscritos">
                      <thead>
                        <tr>
                    ...
                    <div class="scroll-area">
                      <table class="table table-sm mb-0">
                        <tbody id="tbodyInscritos"></tbody> <!-- ← tbody REAL -->
                      </table>
                    </div>
                  </div>
                </div>
              ...
              <!-- Botones transfer -->
              <div class="col-md-2 transfer-col">
                <button type="button" id="btnPasarADerecha" class="btn-transfer primary" title="Pasar a inscritos">
                  <i class="fa fa-arrow-right"></i>
                </button>
                <button type="button" id="btnPasarAIzquierda" class="btn-transfer secondary" title="Quitar de inscritos">
              ...
              <div class="col-md-5">
                <div class="card-box">
                  <h6>
                    No inscritos
                    <span class="badge-soft" id="countNoInscritos">0</span>
                  </h6>
                  <div class="table-slim">
                    <table class="table table-sm table-hover mb-0" id="tablaNoInscritos">
                      <thead>
                        <tr>
                          <th style="width:50px;"></th>
                          <th>Nombre</th>
                    ...
                    <div class="scroll-area">
                      <table class="table table-sm mb-0">
                        <tbody id="tbodyNoInscritos"></tbody> <!-- ← tbody REAL -->
                      </table>
                    </div>
                  </div>
                </div>
    ...
    <!-- Modal de Edición (no se usa aquí, lo dejo igual) -->
