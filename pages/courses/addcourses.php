...
<head>
  ...
  <link href="../../assets/css/styleAddCourses.css" rel="stylesheet">
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <main class="body-content">
    ...
    <div class="ms-content-wrapper">
      ...
      <!-- Agregar Materia Formulario -->
      <div class="col-lg-12">
        <div class="ms-panel">
          <div class="ms-panel-header">
            <h6>Agregar Nueva Materia</h6>
          </div>
          <div class="ms-panel-body">

            <form id="formAgregarMateria" action="../php/agregar_materia.php" method="POST" enctype="multipart/form-data">
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="nombre">Nombre de la materia: </label>
                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ej. español" required>
                  </div>
                </div>

                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="nivel_grado">Nivel de Grado: </label>
                    <select class="form-control" name="nivel_grado" id="nivel_grado" required>
                ...
                <div class="col-12">
                  <div class="form-group">
                    <label for="descripcion">Detalles de la materia: </label>
                    <textarea class="form-control" name="descripcion" id="descripcion" rows="5" placeholder="Ej. Materia para primaria etc." required></textarea>
                  </div>
                </div>
                ...
                <div class="col-12 d-flex justify-content-center">
                  <div class="file-center">
                    <div class="form-group mb-0">
                      <label class="mb-2 d-block text-center" for="imagenMateria">Imagen ilustrativa:</label>
                      <div class="card shadow-sm border-0">
                        <div class="card-body py-3">
                          <div class="input-group">
                            <div class="custom-file">
                              <input type="file" class="custom-file-input" name="foto" id="imagenMateria" accept="image/png,image/jpeg,image/webp,image/gif">
                              <label class="custom-file-label" for="imagenMateria">Seleccionar imagen…</label>
                            </div>
              ...
              <div class="row">
                <div class="col-12 text-center my-4">
                  ...
                  <button type="button" class="btn btn-outline-warning ml-3" onclick="resetForm()">Cancelar</button>
                </div>
              </div>
  ...
  <script src="../scripts/animacionAgregarMateria.js"></script>

  <!-- Weeducate core JavaScript -->
  <script src="../../assets/js/framework.js"></script>
  <script src="../scripts/limpiarPreviewAddCourses.js"></script>
