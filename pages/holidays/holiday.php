    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventSources: [
          ...
          // Ciclos/Periodos (background) e Incidentes/Avisos desde BD
          {
            url: '../php/api_calendar.php',
            method: 'GET',
        ...
        eventClick: function (info) {
          ...
          const sameDay = calendar.getEvents().filter(ev => {
            ...
            if (e) { // rangos (festivos de varios días)
              return ymd >= s && ymd < e;
            } else {
              return ymd === s;
            }
