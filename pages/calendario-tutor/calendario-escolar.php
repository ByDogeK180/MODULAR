...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <main class="body-content">
    ...
    <!-- Modal editar nota (Bootstrap 4: close correcto) -->
    ...
    <!-- Otros modales (dejados iguales, pero con data-dismiss de BS4) -->
    <div id="modal-view-event" class="modal modal-top fade calendar-modal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div id="modal-view-event-add" class="modal modal-top fade calendar-modal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form id="add-event">
            <div class="modal-body">
  ...
  <!-- SCRIPTS -->
  <!-- Orden correcto (jQuery -> Popper -> Bootstrap 4) -->
